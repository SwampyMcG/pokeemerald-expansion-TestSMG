const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_LEADER_BROCK]       = TRAINER_PIC_LEADER_BROCK_FRLG,
    [FACILITY_CLASS_LEADER_MISTY]       = TRAINER_PIC_LEADER_MISTY_FRLG,
    [FACILITY_CLASS_LEADER_LT_SURGE]    = TRAINER_PIC_LEADER_LT_SURGE_FRLG,
    [FACILITY_CLASS_LEADER_ERIKA]       = TRAINER_PIC_LEADER_ERIKA_FRLG,
    [FACILITY_CLASS_LEADER_KOGA]        = TRAINER_PIC_LEADER_KOGA_FRLG,
    [FACILITY_CLASS_LEADER_SABRINA]     = TRAINER_PIC_LEADER_SABRINA_FRLG,
    ...
    [FACILITY_CLASS_LEADER_LORELEI]     = TRAINER_PIC_ELITE_FOUR_LORELEI_FRLG,
    [FACILITY_CLASS_LEADER_BRUNO]       = TRAINER_PIC_ELITE_FOUR_BRUNO_FRLG,
    [FACILITY_CLASS_LEADER_AGATHA]      = TRAINER_PIC_ELITE_FOUR_AGATHA_FRLG,
    [FACILITY_CLASS_LEADER_LANCE]       = TRAINER_PIC_ELITE_FOUR_LANCE_FRLG,
    [FACILITY_CLASS_LEADER_ROARK]       = TRAINER_PIC_LEADER_ROARK,
    [FACILITY_CLASS_LEADER_GARDENIA]    = TRAINER_PIC_LEADER_GARDENIA,
    [FACILITY_CLASS_LEADER_MAYLENE]     = TRAINER_PIC_LEADER_MAYLENE,
    [FACILITY_CLASS_LEADER_CRASHER_WAKE] = TRAINER_PIC_LEADER_CRASHER_WAKE,
    [FACILITY_CLASS_LEADER_FANTINA]     = TRAINER_PIC_LEADER_FANTINA,
    [FACILITY_CLASS_LEADER_BYRON]       = TRAINER_PIC_LEADER_BYRON,
    [FACILITY_CLASS_LEADER_CANDICE]     = TRAINER_PIC_LEADER_CANDICE,
    [FACILITY_CLASS_LEADER_VOLKNER]     = TRAINER_PIC_LEADER_VOLKNER,
};
...
const enum TrainerClassID gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_LEADER_ERIKA]       = TRAINER_CLASS_LEADER,
    [FACILITY_CLASS_LEADER_KOGA]        = TRAINER_CLASS_LEADER,
    ...
    [FACILITY_CLASS_LEADER_LORELEI]     = TRAINER_CLASS_ELITE_FOUR,
    [FACILITY_CLASS_LEADER_BRUNO]       = TRAINER_CLASS_ELITE_FOUR,
    [FACILITY_CLASS_LEADER_AGATHA]      = TRAINER_CLASS_ELITE_FOUR,
    [FACILITY_CLASS_LEADER_LANCE]       = TRAINER_CLASS_ELITE_FOUR,
    [FACILITY_CLASS_LEADER_ROARK]       = TRAINER_CLASS_LEADER,
    [FACILITY_CLASS_LEADER_GARDENIA]    = TRAINER_CLASS_LEADER,
    [FACILITY_CLASS_LEADER_MAYLENE]     = TRAINER_CLASS_LEADER,
    [FACILITY_CLASS_LEADER_CRASHER_WAKE] = TRAINER_CLASS_LEADER,
    [FACILITY_CLASS_LEADER_FANTINA]     = TRAINER_CLASS_LEADER,
    [FACILITY_CLASS_LEADER_BYRON]       = TRAINER_CLASS_LEADER,
    [FACILITY_CLASS_LEADER_CANDICE]     = TRAINER_CLASS_LEADER,
    [FACILITY_CLASS_LEADER_VOLKNER]     = TRAINER_CLASS_LEADER,
};
